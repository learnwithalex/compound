          ...
          <div>
            ...
            {/* Google */}
              <a
                ...
                className="mt-8 flex w-full items-center justify-center gap-2.5 rounded-lg bg-white py-2.5 text-[14px] font-medium text-[#1a1a1a] transition-colors hover:bg-[#f5f5f4]"
                style={{ border: "1px solid #dddad5" }}
              >
